...
class BaseDetector(nn.Module, metaclass=ABCMeta):
    ...
    @property
    def with_selsa_head(self):
        return hasattr(self, 'selsa_head') and self.selsa_head is not None
    ...
    def forward_test(self, imgs, img_metas, **kwargs):
        ...
        if num_augs == 1:
            if hasattr(self, 'get_roi_feats'):
                return self.simple_test_frames(imgs[0], img_metas[0], **kwargs)
